cc.Class({
    ...
    onLoad: function () {
        ...
        this.maxWdith = this.node.parent.getComponent("groundBox").maxWidth;
        this.minWdith = this.node.parent.getComponent("groundBox").minWidth;
    },
    ...
    moveIn: function(startPos){
        ...
        this.node.width = this.node.parent.getComponent("groundBox").minWidth + 
                            cc.random0To1() * this.node.parent.getComponent("groundBox").maxWidth;
